import { Text, View, Pressable, useWindowDimensions, Image, TextInput } from 'react-native';
...
export default function loginScreen() {
    ...
    return (
        <View className="bg-[#F1F5F9] flex-1">
            ...
            <View className="bg-[#F1F5F9] px-6 pt-6 pb-12 gap-4">
                ...
                <Pressable className="bg-[#87CEEB] items-center justify-center p-4 rounded-2xl">
